...
#'
#' This function runs a MaAsLin3 analysis on the provided abundance table and metadata.
#'
...
#' @param other_params A list of other parameters to pass to Maaslin3
#' @param output_dir The directory to save the MaAsLin3 output
#' @param rowtype The type of data in the rows of abund_table ("feature" or "sample")
#'
#' @return The results of the MaAsLin3 analysis
#'
#' @import maaslin3
#' @import tryCatchLog
#' @import assertthat
#'
#' @export
run_maaslin3 <- function(abund_table, metadata_table, fixed_effects, random_effects = NULL,
    ...
    tryCatch({
        ...
        results <- do.call(maaslin3::maaslin3, all_params)
        return(results)
    }, error = function(e) {
        stop(paste("Error in MaAsLin3 execution:", e$message))
    })
